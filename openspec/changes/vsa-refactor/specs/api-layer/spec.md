# Capability: api-layer (Delta Spec)

## Purpose
This delta spec modifies the existing `api-layer` capability to reflect the migration from Controllers to Vertical Slice Architecture.
