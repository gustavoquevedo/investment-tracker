# Base Standards Structure

## Purpose
Defines the directory structure and organization of reusable development standards (`base/`) and project-specific documentation (`project/`).
