...
## Purpose
Display detailed asset-level information on the Assets page, including a snapshot pivot table and stacked area charts for value and allocation over time.
