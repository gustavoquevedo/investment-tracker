...
- Service modules export objects or named functions (e.g., `assetService.js`)
- Component files use PascalCase naming (e.g., `AssetDetails.js`)
- Service files use camelCase with "Service" suffix (e.g., `assetService.js`)
