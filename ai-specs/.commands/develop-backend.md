...
4. Implement the necessary changes to solve the ticket, following the order of the different tasks and making sure you accomplish all of them in order, like writing and running tests to verify the solution (using MTP and xUnit v3), updating documentation, etc. Adhere strictly to **.NET 10 / C# 14 best practices** (field keyword, CPM, .slnx, VSA) as defined in `ai-specs/specs`.
